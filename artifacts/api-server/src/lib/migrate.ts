...
export async function runMigrations(): Promise<void> {
  ...
  const selfHeal = ["0036_portal_content.sql", "0037_legal_entity_finance.sql", "0038_properties_columns_heal.sql", "0039_crm_announcements_telegram.sql", "0040_rbac_permissions.sql", "0041_contract_terminations.sql", "0042_tax_invoice_docs.sql", "0043_portal_access.sql", "0044_portal_engagement.sql", "0045_chat_attachments_contact_phones.sql"];
