...
const ROLE_TAB_CAP: Record<string, DashboardTabId[] | "all"> = {
	...
	construction_director: ["construction", "supply", "sales"],
	chief_accountant: ["finance"],
	construction_project_manager: ["construction", "supply"],
	commercial_director: ["sales", "rental", "construction"],
	financial_director: ["finance"],
	finance_operations_specialist: ["finance"],
	rental_department_head: ["rental"],
	rental_specialist: ["rental"],
	sales_department_head: ["sales", "construction"],
	pto_engineer: ["construction"],
	supply_specialist: ["supply", "construction"],
	lawyer: ["construction", "rental", "sales"],
	cashier: ["finance", "rental"],
...
const ROLE_DEFAULT_TAB: Record<string, DashboardTabId> = {
	...
	admin: "control",
	super_admin: "control",
	general_director: "control",
	executive_operations_director: "control",
	construction_director: "construction",
	chief_accountant: "finance",
	...
	rental_department_head: "rental",
	rental_specialist: "rental",
	sales_department_head: "sales",
	pto_engineer: "construction",
	supply_specialist: "supply",
	lawyer: "construction",
	cashier: "finance",
	rental_manager: "rental",
	sales_manager: "sales",
