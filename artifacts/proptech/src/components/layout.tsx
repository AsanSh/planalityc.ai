		...
		>
			...
			<div className="flex-1 flex flex-col min-w-0 overflow-hidden">
				...
				<div className="flex min-h-0 flex-1">
					...
					<div className="mt-3 space-y-2 border-t border-slate-200/80 pt-3 dark:border-white/8">
							{canOpenSystemSettings && (
								<Link href={activeModuleSettingsHref}>
									<div className="flex h-9 items-center gap-2.5 rounded-full px-3 text-sm font-medium text-slate-700 transition-all hover:bg-slate-100 hover:text-slate-950 dark:text-white/70 dark:hover:bg-white/8 dark:hover:text-white">
										<Settings className="h-4 w-4 text-slate-500 dark:text-cyan-200" />
										<span>Настройки</span>
									</div>
								</Link>
							)}
							<div className="rounded-[16px] border border-slate-200/80 bg-white/76 p-1 shadow-sm shadow-slate-950/5 dark:border-white/10 dark:bg-white/[0.045]">
								<UserProfileDropdown />
							</div>
						</div>
					</aside>
